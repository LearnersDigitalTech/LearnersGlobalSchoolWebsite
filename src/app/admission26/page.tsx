...
import Skill100Section from '@/components/Skill100Section'
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .sticky-cta a,.sticky-cta button{flex:1;text-align:center;padding:12px 8px;border-radius:8px;font-weight:600;font-size:14px;text-decoration:none;letter-spacing:.01em}
        .sc-call{background:#25d366;color:#fff}
        .sc-enquire{background:var(--blue);color:#fff;border:none;cursor:pointer;font-family:inherit}
      ...
      {loading && <div className="loading-overlay active"><div className="spinner" /></div>}

      <div className="sticky-cta">
        <a href="tel:+919916933202" className="sc-call" onClick={handlePhone}>📞 Call Now</a>
        <button className="sc-enquire" onClick={scrollToForm}>✏️ Enquire Now</button>
      </div>
      ...
      <div className="school-banner">
        <img src="https://learnersglobalschool.com/_next/image?url=%2Fimages%2FCampus.webp&w=1920&q=75" alt="Learners Global School Campus" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 30%' }} />
            ...
            <>
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div className="form-group">
                  ...
                  <input id="parentName" type="text" placeholder="Your full name" autoComplete="name" required value={form.parentName} onChange={e => setForm({...form, parentName: e.target.value})} />
                </div>
                <div className="form-row">
                  <div className="form-group">
                    <label htmlFor="phone">Mobile Number <span>*</span></label>
                    <input id="phone" type="tel" placeholder="+91 98765 43210" autoComplete="tel" required value={form.phone} onChange={e => setForm({...form, phone: e.target.value})} />
                  </div>
                  <div className="form-group">
                    <label htmlFor="email">Email Address</label>
                    <input id="email" type="email" placeholder="your@email.com" autoComplete="email" value={form.email} onChange={e => setForm({...form, email: e.target.value})} />
                  </div>
                </div>
                <div className="form-row">
                  <div className="form-group">
                    <label htmlFor="childName">Child's Name <span>*</span></label>
                    <input id="childName" type="text" placeholder="Child's name" required value={form.childName} onChange={e => setForm({...form, childName: e.target.value})} />
                  </div>
                  <div className="form-group">
          ...
          <div className="why-list">
            {[
              ...
              <div className="why-item" key={i}>
                ...
                <div className="why-body"><strong>{title}</strong><p>{text}</p></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="lgs-section" style={{background:'var(--off)'}}>
        <div className="section-inner">
          ...
          <div className="testimonial"><p>"The holistic approach to education here has truly transformed my son's learning journey. The teachers genuinely care about each child's individual growth and potential."</p><div className="testimonial-by">Kavithashree K S — Mother of Bhuvan S Gowda, Grade 8</div></div>
          <div className="testimonial"><p>"We transferred our daughter from another school in Class 7. The difference in engagement and confidence has been remarkable within just one term."</p><div className="testimonial-by">Sandeep Babu R — Father of Samruddhi S, Grade 8</div></div>
        </div>
      </section>
...
</section>   {/* ← this is the end of "Seats Are Filling Fast" */}

      <Skill100Section />   {/* ← ADD THIS LINE */}

      <footer>   {/* ← footer continues below */}
